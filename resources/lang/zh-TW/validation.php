...
return [
    ...
    */
    ...
    'gte' => [
        ...
        'array' => ':attribute 必須包含 :value 項或更多。',
    ],
    ...
    'lte' => [
        ...
        'array' => ':attribute 必須不得超過 :value 項。',
    ],
    'max' => [
    ...
    'starts_with' => ':attribute 必須以下列之一為開頭: :values',
    ...
    */
    ...
    'attributes' => [
        'backend' => [
            'access' => [
                ...
                'users' => [
                    ...
                    'send_confirmation_email' => '發送認證電子郵件',
                    'timezone' => '時區',
                    'language' => '語言',
                ],
            ],
        ...
        'frontend' => [
            ...
            'name' => '使用者名',
            'password' => '密碼',
            'password_confirmation' => '密碼(再次確認)',
            'phone' => '手機',
            'message' => '訊息',
            'old_password' => '舊密碼',
            'new_password' => '新密碼',
            'new_password_confirmation' => '新密碼(再次確認)',
            'timezone' => '時區',
            'language' => '語言',
        ],
    ],
