    ...
    'backend' => [
        'access' => [
            ...
            'users' => [
                ...
                'cant_delete_admin' => '您不能删除超级管理员。',
                'cant_delete_self' => '您不能删除自己',
                'cant_delete_own_session' => '您不能删除自己的会话',
                'cant_restore' => '此用户未删除，因此无法恢复。',
                'cant_unconfirm_admin' => '您不能取消超级用户的确认。',
                'cant_unconfirm_self' => '您不能取消自己的确认。',
                ...
                'role_needed_create' => '您必须选择至少一个角色。',
                'role_needed' => '您必须选择至少一个角色。',
    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'created_pending' => '您的账户已经成功创建，并等待处理。 账户成功处理后会发送电子邮件确认。',
                'mismatch' => '您的确认码不匹配。',
                'not_found' => '该确认码不存在。',
                'pending' => '您的账户正在等待处理',
