...
export default {
            ...
            theme: {
                ...
                options: [
                    ...
                    },
                    {
                        text: "新年限定主題",
                        class:
                            "bg-ch-new-year-2019-red color-ch-new-year-2019-yellow",
                    ...
                    },
                    {
                        text: "反向 新年限定主題",
                        class:
                            "bg-ch-new-year-2019-yellow color-ch-new-year-2019-red",
    ...
    methods: {
        ...
        drawingBackgroundImage() {
            ...
            switch (this.theme.selector) {
                ...
                case "05326525f82b9a036e1bcb53a392ff7c":
                    ...
                    img.src =
                        "/img/frontend/cards/fragmented_background_arrow.png";
        ...
        contentSplit() {
            let content =
                this.canvas.content !== null ? this.canvas.content : "";
            let response_list = [];
                ...
                preConfirm: login => {
                    ...
                    if (this.avatar) {
                        ...
                        data = {
                            ...
                            isFeatureToBeCoutinued: this.canvas.feature
                                .is_to_be_continued
                        };
                    }
