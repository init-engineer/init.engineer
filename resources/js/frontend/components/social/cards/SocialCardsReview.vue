        ...
        <div class="card-columns">
            ...
            <div class="card animated fadeInUp faster"
                ...
                <div class="card-body py-0 px-1">
                    ...
                    <div class="card-text d-flex justify-content-between">
                        <div class="p-1"><a href="javascript:void(0)" class="btn btn-success btn-block ml-auto" v-bind:class="{ disabled: card.review != 0 }" v-on:click="cardSucceeded(card.id)"><span class="badge badge-light">{{ card.succeeded }}</span> 通過</a></div>
                        <div class="p-1 text-success h3" v-if="card.review > 0">◀</div>
                        <div class="p-1 text-danger h3" v-if="card.review < 0">▶</div>
                        <div class="p-1"><a href="javascript:void(0)" class="btn btn-danger btn-block ml-auto" v-bind:class="{ disabled: card.review != 0 }" v-on:click="cardFailed(card.id)"><span class="badge badge-light">{{ card.failed }}</span> 否決</a></div>
                    </div>
                </div>
            </div>
