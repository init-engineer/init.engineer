    ...
    <div class="card card-default">
      <div class="card-header">
        <div style="display: flex; justify-content: space-between; align-items: center;">
          <h3>
            <span>我的應用程式 OAuth Clients</span>
          </h3>
      ...
      <div class="card-body">
        <!-- Current Clients -->
        <p class="mb-0" v-if="clients.length === 0">您尚未建立任何應用程式。</p>
            ...
            <tr v-for="client in clients" :key="client.id">
              ...
              <td style="vertical-align: middle;">
                <a
                  ...
                  :href="'/testing/oauth/authorized/' + client.id"
                  target="_blank"
                >測試</a>
              </td>
            </tr>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">建立新的應用程式</h4>
            ...
            <form role="form">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  ...
                  <span class="form-text text-muted">您的使用者會看到並且信任的名稱。</span>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  ...
                  <span class="form-text text-muted">您的應用程式通過授權後所轉址的 Callback URL。</span>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-9">
                  ...
                  >要求使用者端使用加密傳輸進行身份驗證，加密可以確保使用安全的方式獲取憑證，而不會將其暴露給未經授權的開發者，公開的應用程式（例如桌面應用程式或 JavaScript SPA 應用程式）無法安全地儲存加密。</span>
                </div>
              </div>
            </form>
          </div>
