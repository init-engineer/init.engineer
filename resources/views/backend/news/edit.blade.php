...
@section('title', __('labels.backend.news.management') . ' | ' . __('labels.backend.news.edit'))
...
@section('content')
    {{ html()->modelForm($news, 'PATCH', route('admin.news.update', $news->id))->class('form-horizontal')->attribute('enctype', 'multipart/form-data')->open() }}
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-5">
                        <h4 class="card-title mb-0">
                            ...
                            <small class="text-muted">@lang('labels.backend.news.edit')</small>
                        </h4>
                    </div><!--col-->
                </div><!--row-->
                ...
                <div class="row mt-4 mb-4">
                    <div class="col">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <img src="{{ $news->getPicture() }}" class="rounded m-1" style="max-width: 256px;">
                                {{ html()->file('image')
                                    ->class('form-control') }}
                            </div><!--col-->
                        </div><!--form-group-->
