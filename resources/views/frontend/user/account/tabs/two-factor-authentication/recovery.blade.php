                ...
                <x-frontend.card>
                    ...
                    <x-slot name="body">
                        ...
                        <x-forms.patch :action="route('frontend.auth.account.2fa.update')" name="confirm-item">
                            <button class="btn btn-lg btn-block btn-danger mb-3" type="submit">@lang('Generate New Backup Codes')</button>
                        </x-forms.patch>
                        ...
                        <a href="{{ route('frontend.user.account', ['#two-factor-authentication']) }}" class="btn btn-lg btn-block btn-success">@lang('I have stored these codes in a safe place')</a>
                    </x-slot>
                </x-frontend.card>
            </div><!--col-md-8-->
        </div><!--row-->
