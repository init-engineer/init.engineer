    ...
    public function update(Ads $ads, array $data) : Ads
    {
        return DB::transaction(function () use ($ads, $data) {
            if ($ads->update([
                ...
                'ads_path'     => $data['ads_path']     ?? $ads->ads_path,
                'number_count' => $data['number_count'] ?? $ads->number_count,
                ...
                'started_at'   => $data['started_at']   ?? $ads->started_at,
                'end_at'       => $data['end_at']       ?? $ads->end_at,
            ])) {
