...
class FacebookCommentsJob implements ShouldQueue
{
    ...
    public function handle()
    {
         ...
         */
        dispatch(new FacebookCommentJob($this->platform, $this->platformCards, $this->platform->config['user_id'], $this->platformCards->platform_string_id, $accessToken, null))->onQueue('lowest');
    }
}
