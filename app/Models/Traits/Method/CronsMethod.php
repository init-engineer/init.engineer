...
trait CronsMethod
{
    ...
    public static function weeklyAt(string $command, string $weekly = 'sundays', string $daily = '00:00') : bool
    {
        ...
        switch ($weekly)
        {
            case 'mondays':    $_next_weekly = 0; break; # 星期一
            case 'tuesdays':   $_next_weekly = 1; break; # 星期二
            case 'wednesdays': $_next_weekly = 2; break; # 星期三
            case 'thursdays':  $_next_weekly = 3; break; # 星期四
            case 'fridays':    $_next_weekly = 4; break; # 星期五
            case 'saturdays':  $_next_weekly = 5; break; # 星期六
            case 'sundays':    $_next_weekly = 6; break; # 星期日
        }
