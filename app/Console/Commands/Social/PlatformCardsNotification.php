...
/**
 * Class PlatformCardsNotification.
 *
 * @extends Command
 */
class PlatformCardsNotification extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'social:platform-card-notification';
     ...
     * @var string
     */
    protected $description = '檢查近期新增的文章，是否有被通知到社群平台。';
    ...
    public function handle()
    {
        ...
        echo "========================================\n\r";
        echo "[$startCarbonString] 檢查近期新增的文章，是否有被通知到社群平台。\n\r";
        echo "========================================\n\r";
        ...
        foreach ($cards as $card) {
            /**
             * 爬出該文章目前通知到的社群平台當中的資料
             * 透過 array_diff 來找出還沒有通知過去的社群平台
             */
         ...
         */
        echo "========================================\n\r";
        echo "[$endCarbonString] 完成檢查近期新增的文章，是否有被通知到社群平台。\n\r";
        echo sprintf(
            "總共耗時 %s:%s:%s\n\r",
